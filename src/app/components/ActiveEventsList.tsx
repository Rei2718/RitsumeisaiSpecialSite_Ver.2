  ...
  return (
    <div className='w-4/5 py-5 mx-auto max-w-md'>
      <div className="bg-white/30 backdrop-blur-lg backdrop-white rounded-2xl">
        ...
        <div className={`grid gap-4 p-4 ${activeEventList.length > 1 ? 'grid-cols-2' : 'grid-cols-1'}`}>
          {activeEventList.map(event => (
            <div key={event.id} className="w-full mx-auto py-2 flex items-center justify-center animate-pulse">
